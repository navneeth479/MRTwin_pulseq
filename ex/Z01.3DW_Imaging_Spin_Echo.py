...
gx_diff = make_trapezoid(channel='x', flat_area=500, flat_time=20e-3, system=system)
gy_diff = make_trapezoid(channel='y', flat_area=500, flat_time=5e-3, system=system)
gx_diff_inver = make_trapezoid(channel='x', flat_area=-500, flat_time=5e-3, system=system)
gy_diff_inver = make_trapezoid(channel='y', flat_area=-500, flat_time=5e-3, system=system)
# gz_diff = make_trapezoid(channel='z', flat_area=100, flat_time=5e-3, system=system)
# gz_diff_inver = make_trapezoid(channel='z', flat_area=-100, flat_time=5e-3, system=system)
...
for ii in range(-Nphase//2, Nphase//2):  # e.g. -64:63
    ...
    seq.add_block(gx_diff,gy_diff)
    seq.add_block(make_delay(2e-3))
    seq.add_block(gx_diff_inver,gy_diff_inver)
    seq.add_block(rf1)
