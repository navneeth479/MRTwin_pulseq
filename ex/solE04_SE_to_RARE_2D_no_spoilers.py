experiment_id = 'E04_SE_to_RARE_2D_no_spoilers_Nav_fruit3'
# Scanner experiment
...
rf2, gz180,_ = make_sinc_pulse(flip_angle=120* math.pi / 180, duration=1e-3,slice_thickness=slice_thickness, apodization=0.5, time_bw_product=4, system=system)
...
for ii in range(-Nphase//2, Nphase//2):  # e.g. -64:63
    ...
    gp_= make_trapezoid(channel='y', area=-ii/fov*zoom, duration=1e-3, system=system)
