...
gx_diff = make_trapezoid(channel='x', flat_area=500, flat_time=5e-3, system=system)
...
gz_diff = make_trapezoid(channel='z', flat_area=500, flat_time=5e-3, system=system)
gz_diff_inver = make_trapezoid(channel='z', flat_area=-500, flat_time=5e-3, system=system)
...
for ii in range(-Nphase//2, Nphase//2):  # e.g. -64:63
    ...
    seq.add_block(gx_diff_inver,gy_diff_inver,gz_diff_inver)
