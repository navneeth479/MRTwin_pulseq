experiment_id = 'exB04_Z01.8_FIESTA_jonaspetersen'
...
# Define rf events
rf1, _,_ = make_sinc_pulse(flip_angle=120 * math.pi / 180, duration=1e-3,slice_thickness=slice_thickness, apodization=0.5, time_bw_product=4, system=system)
rf2,_,_ = make_sinc_pulse(flip_angle=-120 * math.pi / 180, phase_offset=-90*np.pi/180, duration=1e-3,slice_thickness=slice_thickness, apodization=0.5, time_bw_product=4, system=system)
